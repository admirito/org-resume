...
- A scalable high-performance streaming data generator that can be
  used to simulate the real-time input for various systems, developed
  with Python, 2022 -- /Present/
...
- An extension for MongoDB's Python driver pymongo for auditing,
  [[https://github.com/admirito/pymongowatch][PyMongoWatch]] on my GitHub, 2022 -- /Present/

- A proposal/specification for defining interactive form-based UIs,
  [[https://github.com/admirito/pitaya-form][PitayaForm]] on my GitHub, 2022 -- /Present/
