...
#+BEGIN_SRC shell :tangle no :results output
  ...
  preamble+='Developer, Software Architect, DevOps specialist<br>'
  preamble+='Esfahan, Iran<br>'
  preamble+='</div>'
  preamble+='<div id=\"contact\">'
  preamble+='<span class=\"name\">&nbsp;</span><br>'
  preamble+='Skype: <a href=\"https://tinyurl.com/skype-mrazavi64-add\">mrazavi64</a><br>'
...
#+BEGIN_SRC latex
  ...
  \renewcommand{\mytitle}{\normalsize\@author\\\footnotesize Developer, Software Architect, \\ \vspace{-0.02in} DevOps specialist
